<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="baitap5.aspx.cs" Inherits="Lab1.baitap5" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Label ID="Label3" runat="server" Text="Bài tập 5: Giải phương trình bậc hai"></asp:Label>
        </div>
        <div>
        ...
        <div>
            <asp:Label ID="Label4" runat="server" Text="Số c:"></asp:Label>
